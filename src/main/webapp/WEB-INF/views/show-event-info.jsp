...
<table id="event-info">
    ...
    <tbody>
        <tr>
            <td class="col-xs-2"><strong>Event Name:</strong></td>
            <td>${event.name}</td>
        </tr>
        <tr>
            <td class="col-xs-2"><strong>Event Start:</strong></td>
            <td>
        ...
        <tr>
            <td class="col-xs-2"><strong>Event End:</strong></td>
            <td>
        ...
        <tr>
            <td class="col-xs-2"><strong>Presenter:</strong></td>
            <td>${event.presenter.firstName} ${event.presenter.lastName}</td>
        </tr>
        <tr>
            <td class="col-xs-2"><strong>Registration Type:</strong></td>
            <td>${event.openRegistration ? "Open" : "Closed"}</td>
        </tr>
        <tr>
            <td class="col-xs-2"><strong>Registration Code:</strong></td>
            <td>${event.registrationCode != null ? event.registrationCode : "<em>none</em>"}</td>
        </tr>
        <tr>
            <td class="col-xs-2"><strong>Survey Required:</strong></td>
            <td>${event.mandatorySurvey ? "Yes" : "No"}</td>
        </tr>
        <tr>
            <td class="col-xs-2"><strong>Max Capacity:</strong></td>
