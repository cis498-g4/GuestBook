...
<form class="form-horizontal" action="update-event" method="post">
        ...
        <div class="row padding-horiz-10px">
            <div class="col-sm-offset-1">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="start-dt" id="start-dt" placeholder="${startDt}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="end-dt" id="end-dt" placeholder="${endDt}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="number" min="0" max="1000" class="form-control" name="capacity" id="capacity" value="${event.capacity > 0 ? event.capacity : ''}">
                    </div>
                </div>
    ...
    <div class="form-group text-center">
        ...
        <input type="submit" class="btn btn-success" value="Update Event Information" ${concluded ? "disabled" : ""}>
    </div>
