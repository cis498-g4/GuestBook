...
/**
 * The Deregister servlet responds to requests to remove a user registration from an event.
 * This is accomplished by deleting an Event Attendance record from the DB.
 */
@WebServlet(name = "Deregister", urlPatterns = "/manager/deregister")
public class Deregister extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageTitle = String.format("Deregister %s %s from %s (%s)?",
